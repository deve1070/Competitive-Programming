...
**Problem:** [1515D-Phoenix-and-Socks](https://codeforces.com/contest/1515/problem/D)
...
The first line of each test case contains three integers n, l, and r (2 ≤ n ≤ 2 ⋅ 10⁵; n is even; 0 ≤ l, r ≤ n; l+r=n) — the total number of socks, and the number of left and right socks, respectively.
...
It is guaranteed that the sum of n across all the test cases will not exceed 2 ⋅ 10⁵.
